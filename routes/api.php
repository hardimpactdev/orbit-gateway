...
Route::middleware(CorrelationHeader::class)->group(function (): void {
    ...
    Route::middleware([WireGuardIdentity::class, RequireGrantPermission::class, LogActivity::class])->group(function (): void {
        ...
        Route::get('/apps/{app}/instances', [AppInstanceController::class, 'index']);
        Route::post('/apps/{app}/instances', [AppInstanceController::class, 'store']);
        Route::get('/apps/{app}/instances/{instance}', [AppInstanceController::class, 'show']);
        Route::delete('/apps/{app}/instances/{instance}', [AppInstanceController::class, 'destroy']);
        Route::get('/apps/{app}/instances/{instance}/env', [AppInstanceEnvController::class, 'index']);
        Route::post('/apps/{app}/instances/{instance}/env', [AppInstanceEnvController::class, 'store']);
        Route::get('/apps/{app}/instances/{instance}/env/render', [AppInstanceEnvController::class, 'render']);
